...
| `runtime_events` | Deduplicated turns/tools, observed lifecycle events, counter resets and skipped transcript lines, timing and command fingerprints |

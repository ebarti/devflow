...
| A25 | User continues a verified completed PR for repair or delivery | Fresh authority and same-PR identity reactivate the original attempt with an atomic claim; original delivery/entry phase/history survive; unresolved actions/results block; repair invalidates affected proof and exact-input delivery needs no fictitious implementation; native merge remains separately evidenced |
...
## Conversational admission revision (0.3.0)
